...
Пример использования оценки следа методом Хатчинсона [\faGithub](https://colab.research.google.com/drive/1aLx_-Sv2tTTKz0NCEFcedqQyopBUczJH#scrollTo=DZTgqcHoa8O3)
