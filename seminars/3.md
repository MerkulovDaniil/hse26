...
## Прямой режим
![Иллюстрация прямого режима автоматического дифференцирования для вычисления производной $v_i$ по $w_k$.](auto_diff_forward.pdf){width=300}

* Использует формулу производной сложной функции
* Имеет сложность $d \times \mathcal{O}(T)$ операций

## Обратный режим
![Иллюстрация обратного режима автоматического дифференцирования для вычисления производной $L$ по узлу $v_i$.](auto_diff_reverse.pdf){width=300}
