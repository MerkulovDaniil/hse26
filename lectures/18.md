...
![](float_formats_bits.pdf){width=82%}
...
* Современные LLM (LLaMA, Qwen) идут ещё дальше — $D/N \gg 20$ (LLaMA-3 8B: ${\sim}1900$ токенов/параметр), но уже из **inference-оптимальности** (меньше модель → дешевле инференс), а не compute-оптимальности ^[[Beyond Chinchilla-Optimal: Accounting for Inference, Sardana et al., 2023](https://arxiv.org/abs/2401.00448)].
