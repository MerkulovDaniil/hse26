...
\addtobeamertemplate{footline}{\raisebox{-1.3pt}{\href{https://fmin.xyz}{\includegraphics[width=1cm]{logo.pdf}}} \hspace{0.2cm} \hbox{\insertsection \hspace{0.2cm}} \hfill \href{https://hse26.fmin.xyz}{\faGem[regular]} \hspace{0.04cm} \href{https://github.com/MerkulovDaniil/hse26}{\faGithub} \hspace{0.07cm} \href{https://t.me/fminxyz}{\faTelegram} \hspace{0.4cm}\hbox{\insertframenumber \hspace{0.1cm}}
  \vskip0pt
}
...
\AtBeginDocument{
  \ifthenelse{\isundefined{\bgimage}}{
    ...
    \setbeamertemplate{title page}{
      \sbox{\coverbox}{\includegraphics{\bgimage}}%
      \begin{tikzpicture}[remember picture,overlay]
        \begin{scope}
          \clip (current page.south west) rectangle (current page.north east);
          \pgfmathtruncatemacro{\iscoverwide}{%
            (\wd\coverbox/\ht\coverbox)>(\the\paperwidth/\the\paperheight)?1:0}%
          \ifnum\iscoverwide=1
            \node[anchor=center, inner sep=0pt] at (current page.center) {%
              \includegraphics[height=1.05\paperheight]{\bgimage}};
          \else
            \node[anchor=center, inner sep=0pt] at (current page.center) {%
              \includegraphics[width=1.05\paperwidth]{\bgimage}};
          \fi
        \end{scope}
